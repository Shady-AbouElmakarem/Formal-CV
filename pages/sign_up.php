...
<body>
    ...
    <section id="firstSection">
        ...
        <div id="signup" class="w3-center openSans">
            <a href="log_in.php" class="w3-btn w3-blue-grey w3-text-pale-blue w3-hover-blue w3-text-hover-white w3-padding-large w3-xlarge">Login</a>
            <a href="sign_up.php" class="w3-btn w3-text-white w3-cyan w3-hover-blue w3-padding-large w3-xlarge">Sign Up</a>
            <div style="padding: 5% 0; clear: both;">
                <form action="sign_up.php" method="post">
                    <label id="email" class="w3-text-red w3-left w3-input" style="border: none;"></label>
                    <input type="email" name="email" placeholder="E-mail" class="email w3-input" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{1,4}">
                    <input type="password" name="password" placeholder="Password" class="email w3-input">
                    <input type="password" name="confirmPassword" placeholder="Confirm Password" class="email w3-input">
                    <input type="submit" name="signup" value="Sign Up &#187" class="w3-btn w3-center w3-cyan w3-hover-blue w3-text-white w3-padding-large w3-xlarge w3-round" style="width: 40%;">
                </form>
                <div></div>
                <div></div>
            </div>
